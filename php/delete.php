...
if($result->num_rows>0)
 ...
 else 
 {
    ...
    echo "project not found or you are not a part of the entered project";
 }
 if(!empty($conid))
 {
...
if($result->num_rows>0)
 ...
 else 
 {
    ...
    echo "conference not found or you are not a part of the entered conference publication";
 }
 if(!empty($jourid))
 {
...
if($result->num_rows>0)
 ...
 else 
 {
    ...
    echo "journal not found or you are not a part of the entered journal publication";
 }
